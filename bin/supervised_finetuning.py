...
MODEL_CLASSES = {
    ...
    # "moonshot": (MoonshotConfig, MoonshotForCausalLM, MoonshotTokenizer)
    # "yarn":(LlamaConfigforyarn, LlamaForCausalLMforyarn, AutoTokenizer)
}
...
def pack_dataset(dataset, chunk_length=4096*1):
    ...
    def chunk(sample, chunk_length=chunk_length):
        ...
        # if not concatenated_examples or all(len(v) == 0 for v in concatenated_examples.values()):
        #     return {}
...
class Seq2SeqTrainingArguments(Seq2SeqTrainingArguments):
    ...
    output_dir: str = field(
        default="/mnt/vepfs/devel/zhangxiaoqing/ICL_BMK/output/llama_8k_shuffle_mmlu_ft_select_and_shuffle_continue",
    ...
    do_pack : bool= field(default=False)
@dataclass
class ModelArguments:
    ...
    model_name_or_path: Optional[str] = field(
        default="/mnt/vepfs/devel/zhangxiaoqing/ICL_BMK/output/llama_8k_shuffle_mmlu_ft_select_and_shuffle/checkpoint-90/",
        metadata={
            "help": (
    ...
    tokenizer_name_or_path: Optional[str] = field(
        default="/mnt/vepfs/devel/zhangxiaoqing/ICL_BMK/bin/llama2-hf-chat-7B/",
        metadata={
            "help": (
    ...
    cache_dir: Optional[str] = field(
        default="/mnt/vepfs/devel/zhangxiaoqing/ICL_BMK/cache/llama_8k_shuffle_mmlu_ft_select_and_shuffle_continue/",
...
class DataArguments:
    ...
    dataset_name: Optional[str] = field(
        default="mbpp", metadata={"help": "The name of the dataset to use (via the datasets library)."}
    )
    dataset_config_name: Optional[str] = field(
        default="/mnt/moonfs/devel/zhangxiaoqing/RPSVR/data/mbpp/mbpp.train.jsonl.20241017", metadata={"help": "The configuration name of the dataset to use (via the datasets library)."}
    )
    # dataset_name: Optional[str] = field(
    ...
    #     [
    #         "/mnt/vepfs/devel/zhangxiaoqing/ICL_BMK/data/icl_8k/in_context_learning_HELM-zhangxiaoqing-20240323-8k-all.jsonl.balance",
    #         # "/mnt/vepfs/devel/zhangxiaoqing/ICL_BMK/data/icl_8k/in_context_learning_HELM-zhangxiaoqing-20240323-8k-all.jsonl.cluster.balance.withid.sortbyattn.addid",
    #         # "/mnt/vepfs/devel/zhangxiaoqing/ICL_BMK/data/icl_8k/in_context_learning_HELM-zhangxiaoqing-20240323-8k-all.jsonl.balance.4k",
    #         # "/mnt/vepfs/devel/maningchen/data/filtered_incontext_learning.jsonl"
    #         # "/mnt/vepfs/devel/maningchen/data/sharegpt/sharegpt_clean.jsonl",
    #         # "/mnt/vepfs/devel/maningchen/data/aplaca-gpt4/aplaca-gpt4.jsonl",
    #         # "/mnt/vepfs/devel/maningchen/data/alpaca_long/alpaca_long.jsonl"
    #         # "/mnt/vepfs/devel/maningchen/data/longbench/long-bench-data.jsonl",
    #         # "/mnt/vepfs/devel/maningchen/data/wizard/WizardLM_evol_instruct_V2_143k.jsonl",
    #         # "/mnt/vepfs/devel/maningchen/data/long_data/long-data.jsonl"
    #         # "/tmp/ICL/dataset/METB/train-00000-of-00001-1028f23e353fbe3e_new.jsonl"
    #     ],
...
class ScriptArguments:
    ...
    target_modules: Optional[str] = field(default="q_proj,v_proj")
...
def main():
    ...
    if training_args.do_train:
        ...
        if trainer.is_world_process_zero():
            ...
            replaced_labels = [label.item() if label != IGNORE_INDEX else tokenizer.pad_token_id for label in sample['labels'][0]]
            logger.debug(f"Decode labels[0]: {tokenizer.decode(replaced_labels)}")
        checkpoint = None
